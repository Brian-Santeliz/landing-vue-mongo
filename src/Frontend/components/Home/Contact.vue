<template>
<div class="site-section mt-3 bg-image2 overlay" id="contact-section" style="background-image: url('../image/hero_1.jpg');">
    <div class="container">
        <div class="row mb-5">
            <div class="col-12 text-center">
                <h2 class="section-title  pt-4 text-white">Contact Us</h2>
            </div>
        </div>
